        ...
        <div className="mb-16 grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <p className="leading-8 text-[#556679]">
              Kami berkomitmen menyediakan layanan internet yang cepat, stabil,
              dan terjangkau untuk membantu aktivitas belajar, bekerja,
              streaming, gaming, dan kebutuhan bisnis Anda setiap hari.
            </p>
